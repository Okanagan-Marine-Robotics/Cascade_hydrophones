module BlockRam_XCORR(
	...
	output reg signed [11:0] waveRef0 [0:3],
	output reg signed [11:0] waveX [0:3],
	output reg signed [11:0] waveY [0:3],
    ...
    always @(negedge clk1Mhz)begin
        ...
        Ram9[wave00Address]<=inWave3;
        Ram10[wave01Address]<=inWave3;
        Ram11[wave02Address]<=inWave3;
        Ram12[wave03Address]<=inWave3;
    end
