...
//               c:/Cascade_hydrophones/WorkspaceOMDHydrophones/Hardware/HydroProccess/HydroProccess.gen/sources_1/bd/MicroBlaze/ip/MicroBlaze_BRAMMUX_1_0/MicroBlaze_BRAMMUX_1_0_stub.v
...
(* CHECK_LICENSE_TYPE = "MicroBlaze_BRAMMUX_1_0,BRAMMUX,{}" *) (* CORE_GENERATION_INFO = "MicroBlaze_BRAMMUX_1_0,BRAMMUX,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=BRAMMUX,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "BRAMMUX,Vivado 2024.2" *) 
module MicroBlaze_BRAMMUX_1_0(waveRef0, waveRef1, waveRef2, waveRef3, Ref0, Ref1, 
