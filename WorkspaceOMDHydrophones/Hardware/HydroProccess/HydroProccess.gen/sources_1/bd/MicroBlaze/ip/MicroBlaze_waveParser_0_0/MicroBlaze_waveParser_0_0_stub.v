...
//               c:/Cascade_hydrophones/WorkspaceOMDHydrophones/Hardware/HydroProccess/HydroProccess.gen/sources_1/bd/MicroBlaze/ip/MicroBlaze_waveParser_0_0/MicroBlaze_waveParser_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "MicroBlaze_waveParser_0_0,waveParser,{}" *) (* CORE_GENERATION_INFO = "MicroBlaze_waveParser_0_0,waveParser,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=waveParser,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "waveParser,Vivado 2024.2" *) 
module MicroBlaze_waveParser_0_0(waveRef, wave, wave1, bufferRef, buffer, buffer1, 
