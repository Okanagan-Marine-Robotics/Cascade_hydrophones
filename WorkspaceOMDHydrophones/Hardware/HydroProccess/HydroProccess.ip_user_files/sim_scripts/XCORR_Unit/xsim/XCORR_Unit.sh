...
#
# Script generated by Vivado on Thu May 22 22:29:49 -0700 2025
...
simulate()
{
  xsim XCORR_Unit -key {Behavioral:sim_1:Functional:XCORR_Unit} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f84b.protoinst" -protoinst "protoinst_files/XCORR_Unit.protoinst" -log simulate.log
}
