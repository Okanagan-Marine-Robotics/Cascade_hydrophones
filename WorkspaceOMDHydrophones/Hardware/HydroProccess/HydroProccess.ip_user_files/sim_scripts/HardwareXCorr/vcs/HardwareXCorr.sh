...
design_libs=(xpm xil_defaultlib xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 dds_compiler_v6_0_22 xlslice_v1_0_2 blk_mem_gen_v8_4_6 xlconstant_v1_1_7)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" +incdir+"../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" +incdir+"../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" \
  ...
  vlogan -work xlslice_v1_0_2 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" +incdir+"../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" +incdir+"../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" \
  ...
  vlogan -work xlconstant_v1_1_7 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" +incdir+"../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.HardwareXCorr xil_defaultlib.glbl -o HardwareXCorr_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./HardwareXCorr_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key HardwareXCorr_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc HardwareXCorr_simv.daidir vcs_lib c.obj)
