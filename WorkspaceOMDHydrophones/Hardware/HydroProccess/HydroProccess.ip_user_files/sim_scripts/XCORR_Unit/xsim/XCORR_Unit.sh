...
#
# Script generated by Vivado on Sun Jun 08 02:18:43 -0700 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : XCORR_Unit.sh
...
#
# Usage        : XCORR_Unit.sh
#                XCORR_Unit.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                XCORR_Unit.sh [-reset_run]
#                XCORR_Unit.sh [-reset_log]
#                XCORR_Unit.sh [-help]
#
...
# script info
echo -e "XCORR_Unit.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./XCORR_Unit.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_9 -L xlslice_v1_0_4 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot XCORR_Unit xil_defaultlib.XCORR_Unit xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim XCORR_Unit -key {Behavioral:sim_1:Functional:XCORR_Unit} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f84b.protoinst" -protoinst "protoinst_files/MicroBlaze.protoinst" -protoinst "protoinst_files/XCORR_Unit.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb XCORR_Unit.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./XCORR_Unit.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: XCORR_Unit.sh [-help]\n\
Usage: XCORR_Unit.sh [-step]\n\
Usage: XCORR_Unit.sh [-lib_map_path]\n\
Usage: XCORR_Unit.sh [-reset_run]\n\
Usage: XCORR_Unit.sh [-reset_log]\n\
Usage: XCORR_Unit.sh [-keep_index]\n\
Usage: XCORR_Unit.sh [-noclean_files]\n\n\
