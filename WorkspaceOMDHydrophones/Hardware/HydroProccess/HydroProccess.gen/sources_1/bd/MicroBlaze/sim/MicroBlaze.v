...
module MicroBlaze
  ...
  MicroBlaze_SineWaveGen_2_0 SineWaveGen_2
       (.clk1Mhz(Net1),
  ...
  MicroBlaze_axi_gpio_2_0 axi_gpio_2
  ...
  MicroBlaze_processing_system7_0_1 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  MicroBlaze_rst_ps7_0_200M_0 rst_ps7_0_200M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
