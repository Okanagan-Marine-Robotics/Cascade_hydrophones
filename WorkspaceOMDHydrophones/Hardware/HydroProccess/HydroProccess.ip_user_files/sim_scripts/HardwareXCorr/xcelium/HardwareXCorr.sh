...
#
# Script generated by Vivado on Fri Sep 13 02:29:20 -0700 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : HardwareXCorr.sh
...
#
# Usage        : HardwareXCorr.sh
#                HardwareXCorr.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                HardwareXCorr.sh [-reset_run]
#                HardwareXCorr.sh [-reset_log]
#                HardwareXCorr.sh [-help]
#
...
#                script (type 'HardwareXCorr.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname xbip_utils_v3_0_10 -libname axi_utils_v2_0_6 -libname xbip_pipe_v3_0_6 -libname xbip_bram18k_v3_0_6 -libname mult_gen_v12_0_18 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_dsp48_addsub_v3_0_6 -libname xbip_dsp48_multadd_v3_0_6 -libname dds_compiler_v6_0_22 -libname xlslice_v1_0_2 -libname blk_mem_gen_v8_4_6 -libname xlconstant_v1_1_7 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 dds_compiler_v6_0_22 xlslice_v1_0_2 blk_mem_gen_v8_4_6 xlconstant_v1_1_7)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "HardwareXCorr.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./HardwareXCorr.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" +incdir+"../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" +incdir+"../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" \
  ...
  xmvlog -work xlslice_v1_0_2 $xmvlog_opts +incdir+"$ref_dir/../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" +incdir+"../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"$ref_dir/../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" +incdir+"../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" \
  ...
  xmvlog -work xlconstant_v1_1_7 $xmvlog_opts +incdir+"$ref_dir/../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" +incdir+"../../../../HydroProccess.gen/sources_1/bd/HardwareXCorr/ipshared/30ef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.HardwareXCorr xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.HardwareXCorr -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log HardwareXCorr_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./HardwareXCorr.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: HardwareXCorr.sh [-help]\n\
Usage: HardwareXCorr.sh [-step]\n\
Usage: HardwareXCorr.sh [-lib_map_path]\n\
Usage: HardwareXCorr.sh [-reset_run]\n\
Usage: HardwareXCorr.sh [-reset_log]\n\
Usage: HardwareXCorr.sh [-keep_index]\n\
Usage: HardwareXCorr.sh [-noclean_files]\n\n\
