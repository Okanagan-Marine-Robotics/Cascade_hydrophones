...
HD_PWD='C:/Cascade_hydrophones/WorkspaceOMDHydrophones/Hardware/HydroProccess/HydroProccess.runs/MicroBlaze_Serializer_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlaze_Serializer_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlaze_Serializer_2_0.tcl
