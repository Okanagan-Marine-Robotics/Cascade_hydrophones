...
HD_PWD='C:/Users/JamesWilliamson/Xcorr/xCorr.runs/HydroDSP_waveParser_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HydroDSP_waveParser_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HydroDSP_waveParser_0_0.tcl
