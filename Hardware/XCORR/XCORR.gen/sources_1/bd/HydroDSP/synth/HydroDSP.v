...
(* CORE_GENERATION_INFO = "HydroDSP,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=HydroDSP,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=17,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,da_board_cnt=3,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "HydroDSP.hwdef" *) 
module HydroDSP
   (bnt,
    clk,
    xcorr_0);
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN HydroDSP_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  output [63:0]xcorr_0;

  wire [13:0]CC_0_wave0Address;
  wire [13:0]CC_0_wave1Address;
  wire [13:0]CC_0_wave2Address;
  wire [13:0]CC_0_wave3Address;
  ...
  wire [13:0]waveParser_0_wave0Address;
  wire [13:0]waveParser_0_wave1Address;
  wire [13:0]waveParser_0_wave2Address;
  wire [13:0]waveParser_0_wave3Address;
  ...
  HydroDSP_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra(waveParser_0_waveRef0Address),
        .addrb(CC_0_waveRef0Address),
  ...
  HydroDSP_blk_mem_gen_0_1 blk_mem_gen_1
       (.addra(waveParser_0_waveRef1Address),
        .addrb(CC_0_waveRef1Address),
        .clka(clk_wiz_1_clk_out1),
        .clkb(clk_wiz_1_clk_out1),
        .dina(waveParser_0_bufferRef),
        .dinb({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b1,1'b0,1'b0,1'b0}),
  ...
  HydroDSP_blk_mem_gen_0_2 blk_mem_gen_2
       (.addra(waveParser_0_wave3Address[11:0]),
        .addrb(CC_0_wave3Address[11:0]),
        .clka(clk_wiz_1_clk_out1),
        .clkb(clk_wiz_1_clk_out1),
  ...
  HydroDSP_blk_mem_gen_0_3 blk_mem_gen_3
       (.addra(waveParser_0_wave2Address[11:0]),
        .addrb(CC_0_wave2Address[11:0]),
        .clka(clk_wiz_1_clk_out1),
        .clkb(clk_wiz_1_clk_out1),
        .dina(waveParser_0_buffer),
        .dinb({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b1,1'b0,1'b0,1'b0}),
  ...
  HydroDSP_blk_mem_gen_0_4 blk_mem_gen_4
       (.addra(waveParser_0_waveRef2Address),
        .addrb(CC_0_waveRef2Address),
        .clka(clk_wiz_1_clk_out1),
        .clkb(clk_wiz_1_clk_out1),
        .dina(waveParser_0_bufferRef),
        .dinb({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b1,1'b0,1'b0,1'b0}),
  ...
  HydroDSP_blk_mem_gen_1_0 blk_mem_gen_5
       (.addra(waveParser_0_waveRef3Address),
        .addrb(CC_0_waveRef3Address),
        .clka(clk_wiz_1_clk_out1),
        .clkb(clk_wiz_1_clk_out1),
        .dina(waveParser_0_bufferRef),
        .dinb({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b1,1'b0,1'b0,1'b0}),
  ...
  HydroDSP_blk_mem_gen_2_0 blk_mem_gen_6
       (.addra(waveParser_0_wave0Address[11:0]),
        .addrb(CC_0_wave0Address[11:0]),
        .clka(clk_wiz_1_clk_out1),
        .clkb(clk_wiz_1_clk_out1),
        .dina(waveParser_0_buffer),
        .dinb({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b1,1'b0,1'b0,1'b0}),
  ...
  HydroDSP_blk_mem_gen_3_0 blk_mem_gen_7
       (.addra(waveParser_0_wave1Address[11:0]),
        .addrb(CC_0_wave1Address[11:0]),
        .clka(clk_wiz_1_clk_out1),
        .clkb(clk_wiz_1_clk_out1),
        .dina(waveParser_0_buffer),
        .dinb({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b1,1'b0,1'b0,1'b0}),
  ...
  HydroDSP_waveParser_0_1 waveParser_0
  ...
  HydroDSP_xlslice_0_0 xlslice_0
