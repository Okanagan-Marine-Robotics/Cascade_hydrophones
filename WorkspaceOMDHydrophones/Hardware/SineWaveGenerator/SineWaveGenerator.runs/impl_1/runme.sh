...
HD_PWD='C:/Cascade_hydrophones/WorkspaceOMDHydrophones/Hardware/SineWaveGenerator/SineWaveGenerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SineWaveGen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SineWaveGen.tcl -notrace
