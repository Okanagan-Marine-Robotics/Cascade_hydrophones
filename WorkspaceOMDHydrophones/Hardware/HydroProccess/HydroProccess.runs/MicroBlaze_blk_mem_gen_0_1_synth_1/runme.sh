...
HD_PWD='C:/Cascade_hydrophones/WorkspaceOMDHydrophones/Hardware/HydroProccess/HydroProccess.runs/MicroBlaze_blk_mem_gen_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlaze_blk_mem_gen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlaze_blk_mem_gen_0_1.tcl
