...
HD_PWD='C:/Cascade_hydrophones/WorkspaceOMDHydrophones/Hardware/HydroProccess/HydroProccess.runs/MicroBlaze_clk1Mhz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlaze_clk1Mhz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlaze_clk1Mhz_1_0.tcl
