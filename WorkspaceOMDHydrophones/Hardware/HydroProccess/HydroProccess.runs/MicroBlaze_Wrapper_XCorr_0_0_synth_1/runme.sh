...
HD_PWD='C:/Cascade_hydrophones/WorkspaceOMDHydrophones/Hardware/HydroProccess/HydroProccess.runs/MicroBlaze_Wrapper_XCorr_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlaze_Wrapper_XCorr_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlaze_Wrapper_XCorr_0_0.tcl
