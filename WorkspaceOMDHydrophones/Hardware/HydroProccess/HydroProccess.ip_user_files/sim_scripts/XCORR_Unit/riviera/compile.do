...
vlog -work xilinx_vip  -incr -l axi_vip_v1_1_19 -l smartconnect_v1_0 -l processing_system7_vip_v1_0_21 "+incdir+C:/Xilinx/Vivado/2024.2/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib -l xlconstant_v1_1_9 -l xlslice_v1_0_4 \
...
vlog -work xpm  -incr -l axi_vip_v1_1_19 -l smartconnect_v1_0 -l processing_system7_vip_v1_0_21 "+incdir+C:/Xilinx/Vivado/2024.2/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib -l xlconstant_v1_1_9 -l xlslice_v1_0_4 \
...
vlog -work xil_defaultlib  -incr -v2k5 "+incdir+C:/Xilinx/Vivado/2024.2/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib -l xlconstant_v1_1_9 -l xlslice_v1_0_4 \
"../../../bd/XCORR_Unit/ip/XCORR_Unit_SineWaveGen_0_0/sim/XCORR_Unit_SineWaveGen_0_0.v" \

vlog -work xlconstant_v1_1_9  -incr -v2k5 "+incdir+C:/Xilinx/Vivado/2024.2/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib -l xlconstant_v1_1_9 -l xlslice_v1_0_4 \
...
vlog -work xlslice_v1_0_4  -incr -v2k5 "+incdir+C:/Xilinx/Vivado/2024.2/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib -l xlconstant_v1_1_9 -l xlslice_v1_0_4 \
