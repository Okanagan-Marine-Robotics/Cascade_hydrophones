...
HD_PWD='C:/Users/JamesWilliamson/Cascade_hydrophones/Hardware/XCORR/XCORR.runs/HydroDSP_clk_wiz_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HydroDSP_clk_wiz_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HydroDSP_clk_wiz_2_0.tcl
