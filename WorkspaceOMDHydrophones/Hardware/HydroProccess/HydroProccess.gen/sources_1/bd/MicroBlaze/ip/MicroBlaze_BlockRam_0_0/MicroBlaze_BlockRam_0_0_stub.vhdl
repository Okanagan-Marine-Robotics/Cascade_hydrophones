...
-- Date        : Tue Feb 18 08:00:17 2025
-- Host        : James running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub
--               c:/Cascade_hydrophones/WorkspaceOMDHydrophones/Hardware/HydroProccess/HydroProccess.gen/sources_1/bd/MicroBlaze/ip/MicroBlaze_BlockRam_0_0/MicroBlaze_BlockRam_0_0_stub.vhdl
...
entity MicroBlaze_BlockRam_0_0 is
  Port ( 
    clk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of MicroBlaze_BlockRam_0_0 : entity is "MicroBlaze_BlockRam_0_0,BlockRam,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of MicroBlaze_BlockRam_0_0 : entity is "MicroBlaze_BlockRam_0_0,BlockRam,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=BlockRam,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of MicroBlaze_BlockRam_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of MicroBlaze_BlockRam_0_0 : entity is "module_ref";
end MicroBlaze_BlockRam_0_0;

architecture stub of MicroBlaze_BlockRam_0_0 is
