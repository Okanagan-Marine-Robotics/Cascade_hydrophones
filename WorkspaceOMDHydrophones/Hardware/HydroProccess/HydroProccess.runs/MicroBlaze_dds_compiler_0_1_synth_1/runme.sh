...
HD_PWD='C:/Cascade_hydrophones/WorkspaceOMDHydrophones/Hardware/HydroProccess/HydroProccess.runs/MicroBlaze_dds_compiler_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlaze_dds_compiler_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlaze_dds_compiler_0_1.tcl
