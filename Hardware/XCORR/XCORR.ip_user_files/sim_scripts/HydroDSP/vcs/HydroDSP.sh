...
design_libs=(xpm xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 dds_compiler_v6_0_22 xil_defaultlib blk_mem_gen_v8_4_6 xlconstant_v1_1_7 xlslice_v1_0_2)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/HydroDSP/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/HydroDSP/ipshared/30ef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/HydroDSP/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/HydroDSP/ipshared/30ef" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/HydroDSP/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/HydroDSP/ipshared/30ef" \
  ...
  vlogan -work xlconstant_v1_1_7 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/HydroDSP/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/HydroDSP/ipshared/30ef" \
  ...
  vlogan -work xlslice_v1_0_2 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/HydroDSP/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/HydroDSP/ipshared/30ef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.HydroDSP xil_defaultlib.glbl -o HydroDSP_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./HydroDSP_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key HydroDSP_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc HydroDSP_simv.daidir vcs_lib c.obj)
