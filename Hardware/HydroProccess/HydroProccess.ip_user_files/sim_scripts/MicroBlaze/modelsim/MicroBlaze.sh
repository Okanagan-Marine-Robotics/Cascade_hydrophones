...
#
<<<<<<< HEAD:WorkspaceOMDHydrophones/Hardware/HydroProccess/HydroProccess.ip_user_files/sim_scripts/MicroBlaze/modelsim/MicroBlaze.sh
# Script generated by Vivado on Thu Nov 07 02:26:01 -0800 2024
=======
# Script generated by Vivado on Tue Nov 05 02:03:06 -0800 2024
>>>>>>> main:Hardware/HydroProccess/HydroProccess.ip_user_files/sim_scripts/MicroBlaze/modelsim/MicroBlaze.sh
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Cascade_hydrophones/Hardware/HydroProccess/HydroProccess.cache/compile_simlib/modelsim"
  fi
