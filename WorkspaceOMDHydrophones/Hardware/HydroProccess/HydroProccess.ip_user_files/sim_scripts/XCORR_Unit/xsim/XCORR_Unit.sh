...
#
# Script generated by Vivado on Fri Mar 14 03:22:02 -0700 2025
...
simulate()
{
  xsim XCORR_Unit -key {Behavioral:sim_1:Functional:XCORR_Unit} -tclbatch cmd.tcl -protoinst "protoinst_files/MicroBlaze.protoinst" -protoinst "protoinst_files/XCORR_Unit.protoinst" -log simulate.log
}
